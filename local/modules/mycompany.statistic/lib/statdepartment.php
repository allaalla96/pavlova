...
class StatDepartmentTable extends Entity\DataManager
{
    ...
    public static function getMap()
    {
        return array(
            ...
            'UF_STAT' => array(
                ...
                'title' => Loc::getMessage('STAT_ENTITY_UF_STAT_FIELD')
            ),
            'UF_VALUE' => array(
                'data_type' => 'float',
                'required' => true,
            ...
            'UF_DEPARTMENT' => array(
                ...
                'required' => true,
                'title' =>
                    Loc::getMessage('STAT_ENTITY_UF_DEPARTMENT_FIELD')
            ),
            'UF_CREATED_BY' => array(
                'data_type' => 'integer',
                'required' => true,

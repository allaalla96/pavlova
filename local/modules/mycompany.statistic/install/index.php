...
Битрикс CModule*/
Class mycompany_statistic extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "mycompany.statistic";
    var $MODULE_ID = "mycompany.statistic";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("mycompany.statistic_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("mycompany.statistic_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("mycompany.statistic_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("mycompany.statistic_PARTNER_URI");
    }
